        ...
        {(close) => (
            <Dialog>
                ...
                <Content>
                    ...
                    <p>
                        <Box size="XS" /> These scripts are matched to requests based on the filter's configured regular expressions. Only requests that pass the filter are evaluated by the mock scripts <code>request()</code> method. If some mock script is matched to the request, its <code>response()</code> method is called to generate the response.
                    </p>
                    <p>
