      ...
      <View>
        <Flex direction="row" justifyContent="space-between" alignItems="center">
          ...
          <Flex flex="1" justifyContent="center" alignItems="center">
            <StatusLight id="health-status" variant={healthIssues.length === 0 ? 'positive' : 'negative'}>{healthIssues.length === 0 ? <>Healthy</> : <>Unhealthy &mdash; {healthIssues.length} issue(s)</>}</StatusLight>
          </Flex>
