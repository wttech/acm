    ...
    {(close) => (
      <Dialog>
        ...
        <Content>
          ...
          <p>
            <Heart size="XS" /> The executor is active only when the instance is healthy, meaning all OSGi bundles are active and no recent core OSGi events have occurred. Some bundles may be ignored to address known issues while still
            considering the instance healthy.
          </p>
          <p>
