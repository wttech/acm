...
public class ResourceScanner {
   ...
   *
   * <p>/ => root node suggestion (with node type etc), and its children /apps, /content, etc
   * (exception) /content => only content node suggestion /content/ => only content node children
   * /content/mysite => only mysite node suggestion /content/mysite/ => only mysite node children
   * etc.
   */
