        ...
        {(close) => (
            <Dialog>
                ...
                <Content>
                    ...
                    <p>
                        <Heart size="XS" /> Script executor is active only when the instance is healthy, meaning all OSGi bundles are active, and no recent core OSGi events have occurred. Some bundles may be ignored, which may be useful to address known issues and still consider the instance as healthy.
                    </p>
                    <p>
