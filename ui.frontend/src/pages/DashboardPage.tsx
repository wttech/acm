...
const DashboardPage = () => {
  return (
    <Grid areas={['welcome allInOne newApproach', 'contentManagement permissionsManagement dataImports']} columns={['1fr', '1fr', '1fr']} gap="size-200" marginY="size-200">
      ...
      <View gridArea="allInOne" backgroundColor="gray-50" borderWidth="thin" borderColor="dark" borderRadius="medium" padding="size-200" minHeight="size-2400">
        <Flex direction="row" alignItems="center" gap="size-200">
          ...
          <Flex direction="column" gap="size-100">
            ...
            <Content>
              ACM may be a good alternative to tools like APM, AECU, AEM Groovy Console, and AC Tool. Groovy language is ideal to manage all things in content including permissions. In tools like APM/AC Tool, there is a need to learn custom
              YAML syntax or languages/grammars. In ACM, you only need Groovy, which almost every Java developer knows! Enjoy a single, painless tool setup in AEM projects with no hooks and POM updates.
            </Content>
          </Flex>
        </Flex>
      </View>
      <View gridArea="newApproach" backgroundColor="gray-50" borderWidth="thin" borderColor="dark" borderRadius="medium" padding="size-200" minHeight="size-2400">
        <Flex direction="row" alignItems="center" gap="size-200">
          ...
          <Flex direction="column" gap="size-100">
            ...
            <Content>
              Experience a different way of using Groovy scripts. ACM ensures the instance is healthy before scripts decide when to run: once, periodically, or at an exact date and time. Execute scripts in parallel or sequentially, offering
              a complete change in paradigm. Unlike traditional methods, ACM allows scripts to run at specific moments offering unmatched flexibility and control.
            </Content>
          </Flex>
        </Flex>
      </View>
      ...
      <View gridArea="dataImports" backgroundColor="gray-50" borderWidth="thin" borderColor="dark" borderRadius="medium" padding="size-200" minHeight="size-2400">
        <Flex direction="row" alignItems="center" gap="size-200">
          ...
          <Flex direction="column" gap="size-100">
            ...
            <Content>
              Effortlessly integrate data from external sources into the JCR repository, enhancing content management capabilities. By simplifying data import implementation, ACM allows developers to focus more on developing better
              components and presenting data effectively, ensuring a user-friendly experience.
            </Content>
          </Flex>
        </Flex>
      </View>
